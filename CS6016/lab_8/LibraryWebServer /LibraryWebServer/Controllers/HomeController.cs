...
namespace LibraryWebServer.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult CheckLogin( string name, int cardnum )
        {
            ...
            bool loginSuccessful = query.Count > 0;
        ...
        public ActionResult AllTitles()
        {
            var query = from t in db.Titles 
                        ...
                        from title in allTitles.DefaultIfEmpty()
                        join co in db.CheckedOut
                        on title.Serial equals co.Serial
                        into CheckoutTitles
                        
                        from coTitle in CheckoutTitles.DefaultIfEmpty()
                        join p in db.Patrons
                        on coTitle.CardNum equals p.CardNum
                        into allBooks
